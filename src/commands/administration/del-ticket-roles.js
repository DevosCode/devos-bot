...
module.exports = {
  ...
  async run({interaction}) {
    ...
    if (!(await deleteGuildSettingByKeyValueGuildId("TICKET_ROLES", role.id, interaction.guild.id))) return error(interaction, "Le rôle n'a pas pus être supprimé.");
