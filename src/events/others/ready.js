...
module.exports = async (client) => {
  let guildId, guild, channelReady;
  ...
  channelReady = guild.channels.cache.get(client.config.channel_message_ready) || await guild.channels.fetch(client.config.channel_message_ready).catch(() => null);
  ...
  channelReady.send("I'm ready bro."); 
};
